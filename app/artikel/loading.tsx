    ...
    <div className="min-h-screen pt-20 pb-16 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-pulse">
          <div className="h-8 bg-blue-200 rounded-full w-48 mx-auto mb-6"></div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Array.from({ length: 3 }).map((_, index) => (
              <div key={index} className="animate-pulse bg-white rounded-2xl shadow-md overflow-hidden h-full">
                <div className="relative h-48 bg-gray-200"></div>
                <div className="p-6">
                  <div className="h-4 bg-blue-100 rounded w-24 mb-3"></div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-12 border animate-pulse">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3 p-6 bg-gray-50 rounded-xl">
